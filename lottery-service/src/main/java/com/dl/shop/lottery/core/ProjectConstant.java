...
public class ProjectConstant {
	public static final String BASE_PACKAGE = "com.dl.shop.lottery";// 项目基础包名称，根据自己公司的项目修改
	...
	/** 选号结果 */
	public static final int msg_ball = 10;
	/** 福彩3D复式玩法 */
	...
	/**
	 * 竞彩篮球直播状态:-1 完；0 未；1 第1节；2 第2节；3 第3节；4 第4节；5 第1'OT；6 第2'OT；7 第3'OT；50
	 * 中场；-2 待定；-3 中断；-4 取消；-5 推迟
	 */
	...
	/**
	 * 0 - 彩票中包含的期次都与比赛结果还未比对完 1 - 彩票中包含的期次都与比赛结果都完成比对
	 * 
	 * */
	...
	public static final int BET_PRESET_TIME = 0;//420;
	// 彩票信息的缓存时长,单位分
