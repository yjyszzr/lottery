...
public class DlArticle {
     ...
     *
     * @param listStyle 列表展示形式 1- 单张图  2-两张图  3-三张图
     */
     ...
     * 设置是否原创 0 - 不是原创 1- 是原创
     *
     * @param isOriginal 是否原创 0 - 不是原创 1- 是原创
     */
     ...
     * 设置是否置顶 0 - 未置顶 1-已置顶
     *
     * @param isStick 是否置顶 0 - 未置顶 1-已置顶
     */
