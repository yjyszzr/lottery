...
@ApiModel("赛事列表页面返回信息")
@Data
public class DlJcLqMatchListDTO implements Serializable{
	...
	public List<DlJcLqMatchDTO> hotPlayList = new ArrayList<DlJcLqMatchDTO>();

	@ApiModelProperty(value = "最近几天的赛事列表", required = true)
	public List<DlJcLqDateMatchDTO> playList = new ArrayList<DlJcLqDateMatchDTO>();
