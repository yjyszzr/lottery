...
@Data
public class DILQUserBetCellInfoDTO implements Serializable{
	...
	public DILQUserBetCellInfoDTO() {}
	
	public DILQUserBetCellInfoDTO(MatchBasketBallBetPlayDTO matchCell){
